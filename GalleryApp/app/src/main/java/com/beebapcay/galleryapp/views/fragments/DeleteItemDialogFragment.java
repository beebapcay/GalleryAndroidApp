...
public class DeleteItemDialogFragment extends DialogFragment {
	...
	Button mCancelButton, mMoveToRecycleBinButton;
	...
	public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
		...
		mMoveToRecycleBinButton = view.findViewById(R.id.action_move_to_recycle_bin);
		mMoveToRecycleBinButton.setOnClickListener(v -> {
